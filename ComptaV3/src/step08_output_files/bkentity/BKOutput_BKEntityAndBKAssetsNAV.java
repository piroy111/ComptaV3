...
public class BKOutput_BKEntityAndBKAssetsNAV extends BKOutputAbstract {

	public BKOutput_BKEntityAndBKAssetsNAV(BKOutputManager _sBKOutputManager) {
	...
	@Override public void buildFileContent() {
		...
		String lLineHeader2 = "BKEntity,NAV total USD";
				...
				if (lBKTransactionPartitionDate != null) {
					...
					for (BKAsset lBKAsset : BKAssetManager.getpListBKAssetSorted()) {
						...
						if (lBKHoldingAssetDate == null) {
							...
							lLine += "," + lBKHoldingAssetDate.getpNAV();
							lNAVTotal += lBKHoldingAssetDate.getpNAV();
						}
					}
					/*
					 * Add beginning
					 */
					lLine = lBKEntity.getpName()
							+ "," + lNAVTotal
							+ lLine;
					/*
					 * Print line
